          ...
          <div className='flex flex-col gap-4'>
            ...
            <div className='max-w-3xl mx-auto'>
              ...
              <form action="" onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
                ...
                <textarea onChange={(e)=>setName(e.target.value)} value={content} name="" id="" placeholder='Comment' className='w-full p-2 border border-gray-300 rounded outline-none h-48'></textarea>
